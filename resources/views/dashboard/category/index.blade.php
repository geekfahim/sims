            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('home') }}">{{ __('Categories') }}</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <a href="{{ route('category.create') }}" class="float-right btn btn-sm bg-gradient-primary"><i
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="" class="btn btn-sm bg-gradient-danger delete-btn"
                                        data-form-id="{{ $category->id }}"><i
